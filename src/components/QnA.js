...
const QnA = ({ srno, question, answer }) => {
    return (
        <AccordianDiv>
            <ThemeProvider theme={theme}>
                <Accordion >
                    <AccordionSummary
                        ...
                        id="panel1a-header"
                    >
                        <Typography gutterBottom variant="srno" component="div" align="left" sx={{ fontWeight: 'bold', textAlign: 'justify'}}>{srno}.</Typography>
                    ...
                    <AccordionDetails>
                        ...
                        <Markdown remarkPlugins={[remarkMath]} rehypePlugins={[rehypeKatex, rehypeRaw]}>{answer}</Markdown>
                        </Typography>
                        <ExpandMoreIcon fill='none' stroke='white' sx={{ color: 'white' }} />
